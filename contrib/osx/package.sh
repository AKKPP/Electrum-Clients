...
export FAKETIME="2024-06-10 00:00:00"
export PATH=$PATH:~/bin


if [ -z "$1" ]; then
    echo "Usage: $0 Chesscoin032-Electrum.app"
    exit -127
fi
...
dmg dmg Electrum_uncompressed.dmg chesscoin032-electrum-$VERSION.dmg || fail "Unable to create compressed dmg"
rm Electrum_uncompressed.dmg

echo "Done."
sha256sum chesscoin032-electrum-$VERSION.dmg
