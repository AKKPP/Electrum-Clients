...
;Variables
  ...
  !define PRODUCT_WEB_SITE "https://github.com/OleksandrAAA/ChessCoin-electrum"
...
Section
  ...
  ;Links chesscoin: URI's to Electrum
  WriteRegStr HKCU "Software\Classes\chesscoin" "" "URL:chesscoin Protocol"
  WriteRegStr HKCU "Software\Classes\chesscoin" "URL Protocol" ""
  WriteRegStr HKCU "Software\Classes\chesscoin" "DefaultIcon" "$\"$INSTDIR\electrum.ico, 0$\""
  WriteRegStr HKCU "Software\Classes\chesscoin\shell\open\command" "" "$\"$INSTDIR\electrum-${PRODUCT_VERSION}.exe$\" $\"%1$\""
...
Section "Uninstall"
  ...
  DeleteRegKey HKCU "Software\Classes\chesscoin"
